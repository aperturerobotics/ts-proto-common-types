...
export const FileDescriptorSet = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<FileDescriptorSet | FileDescriptorSet[]>
      | Iterable<FileDescriptorSet | FileDescriptorSet[]>,
...
export const DescriptorProto = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<DescriptorProto | DescriptorProto[]>
      | Iterable<DescriptorProto | DescriptorProto[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of pkt as any) {
  ...
  async *encodeTransform(
    ...
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        ...
        yield* [
          EnumDescriptorProto_EnumReservedRange.encode(pkt as any).finish(),
        ]
      }
    }
  },
...
export const FileOptions = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<FileOptions | FileOptions[]>
      | Iterable<FileOptions | FileOptions[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of pkt as any) {
...
export const MessageOptions = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<MessageOptions | MessageOptions[]>
      | Iterable<MessageOptions | MessageOptions[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of pkt as any) {
...
export const FieldOptions = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<FieldOptions | FieldOptions[]>
      | Iterable<FieldOptions | FieldOptions[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of pkt as any) {
...
export const OneofOptions = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<OneofOptions | OneofOptions[]>
      | Iterable<OneofOptions | OneofOptions[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of pkt as any) {
...
export const EnumOptions = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<EnumOptions | EnumOptions[]>
      | Iterable<EnumOptions | EnumOptions[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of pkt as any) {
...
export const EnumValueOptions = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<EnumValueOptions | EnumValueOptions[]>
      | Iterable<EnumValueOptions | EnumValueOptions[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of pkt as any) {
...
export const ServiceOptions = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<ServiceOptions | ServiceOptions[]>
      | Iterable<ServiceOptions | ServiceOptions[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of pkt as any) {
...
export const MethodOptions = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<MethodOptions | MethodOptions[]>
      | Iterable<MethodOptions | MethodOptions[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of pkt as any) {
...
export const SourceCodeInfo = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<SourceCodeInfo | SourceCodeInfo[]>
      | Iterable<SourceCodeInfo | SourceCodeInfo[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of pkt as any) {
...
export const GeneratedCodeInfo = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<GeneratedCodeInfo | GeneratedCodeInfo[]>
      | Iterable<GeneratedCodeInfo | GeneratedCodeInfo[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (globalThis.Array.isArray(pkt)) {
        for (const p of pkt as any) {
